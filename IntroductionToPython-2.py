# Projeto Calculadora: Criando uma calculadora simples em Python com tkinter
# Essa calculadora não realiza operações complexas e pode apresentar alguns erros, como a divisão por zero
# A operação associada ao simbolo '%' é a operação de módulo, e não a porcentagem
...
cor2 = "#fafafa" # cor branca
cor3 = "#282d36" # cor azul
cor4 = "#7d7972" # cor cinza
cor5 = "#ffac05" # cor laranja


janela = Tk()
janela.title("Projeto Calculadora")
janela.geometry("235x310") # Largura x Altura da calculadora
janela.config(bg=cor1)

# separando telas/ criando frames com Frame
...
# criando label (parte funcional - somente texto)
# converte string para variável
valor_texto = StringVar()

todos_valores = ''

# criando função (def) para a parte funcional da calculadora
...
# padding = padx
# anchor é em qual direção/coordenada o text irá aparecer
# textvariable recebe o valor da variável valor_texto
...
b_8 = Button(frame_corpo, command = lambda: entrar_valores('*'), text="*", width=5, height=2, bg=cor5, fg=cor2, font=('Ivy 13 bold'), relief= RAISED, overrelief=RIDGE)
